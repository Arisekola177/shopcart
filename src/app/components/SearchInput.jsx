...
const SearchInput = () => {
  ...
  return (
    <div className="flex items-center">
        ...
        type='text'
        autoComplete='off'
         className='md:p-2 xs:p-1 border w-[90%] mx-auto placeholder:text-xs border-gray-300 rounded-l-md focus:outline-none focus:border-[0.5px] focus:border-slate-500'
        />
